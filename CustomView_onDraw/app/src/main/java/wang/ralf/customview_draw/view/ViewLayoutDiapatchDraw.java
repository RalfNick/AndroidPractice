 ...
 **/
public class ViewLayoutDiapatchDraw extends LinearLayout {
    ...
    public ViewLayoutDiapatchDraw(Context context) {
        this(context, null);

    }

    public ViewLayoutDiapatchDraw(Context context, AttributeSet attrs) {
        super(context, attrs);
